...
const AddBook = () => {
  return (
    <div>
      <section className="p-4 lg:px-24 p-6 mx-auto bg-themeColor rounded-md shadow-md dark:bg-gray-800">
        <div>
        ...
        <form>
          ...
          <div className="flex justify-end mt-6">
            <button className="px-8 py-2.5 leading-5 text-themeColor transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
              Save
            </button>
          </div>
        </form>
